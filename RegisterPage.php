...
<form action="RegisterAuth.php" method="post" id="form" style="font-family:Quicksand, sans-serif;background-color:rgba(44,40,52,0.73);width:320px;padding:40px;">
    <h1 id="head" style="color:rgb(193,166,83);">Register</h1>
    <div></div>
        ...
        if(isset($_SESSION['error'])){
            ...
            switch($_SESSION['error']){
                ...
                case "shortPassword":
                    ...
                    break;
                case "noUsername":
                    echo "<p>No username was provided.</p>";
                    break;
            }
    ...
    ?>
    <button class="btn btn-light" id="butonas" style="width:100%;height:100%;margin-bottom:10px;background-color:rgb(106,176,209);" type="submit">Submit</button></form>
